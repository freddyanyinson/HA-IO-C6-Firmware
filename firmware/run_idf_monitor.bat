...
"C:\Users\FREDD\.espressif\python_env\idf6.0_py3.11_env\Scripts\python.exe" "C:\Users\FREDD\esp\v6.0.2\esp-idf\tools\idf.py" -p %IDF_PORT% monitor --print_filter="*:I ESP_ZB_ON_OFF_LIGHT:D ZIGBEE:D LIGHT_DRIVER:D DIAG:D"
goto :done
:ports_error
echo.
echo Connect the board, close any app using the port, then run:
echo   run_idf_ports.bat
echo   run_idf_monitor.bat COMx
:done
endlocal
